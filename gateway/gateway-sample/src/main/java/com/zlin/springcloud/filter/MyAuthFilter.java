package com.zlin.springcloud.filter;

import com.zlin.springcloud.AuthResponse;
import com.zlin.springcloud.AuthResponseCode;
import com.zlin.springcloud.AuthService;
...
public class MyAuthFilter implements GatewayFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        response.getHeaders().add("demo-username",username);
